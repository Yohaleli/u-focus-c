...
// We need to change the layout of the main content
// Find <main ...> and its contents up to the closing </main>
const mainReplacement = `
      <main className="relative z-10 w-full max-w-6xl mx-auto p-6 md:p-12 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20">
        ...
        {/* Info Cards Section */}
        <div className="flex flex-col gap-4 w-full max-w-md lg:mt-0 mt-8">
...
const newContent = content.replace(/<main className="relative z-10 w-full max-w-lg mx-auto p-8 flex flex-col items-center text-center">[\s\S]*<\/main>/, mainReplacement);

fs.writeFileSync('src/components/IntroPage.tsx', newContent);
console.log("IntroPage patched with textboxes");
